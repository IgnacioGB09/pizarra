window.onload = function () {
    ...
    DIBUJAR.lapiz.onclick = function() {
        ...
        DIBUJAR.canvas.ontouchstart = function (e) {
            e.preventDefault();
            this.posicion = DIBUJAR.ajustarPosicion(e.changedTouches[0].clientX - DIBUJAR.xreal, e.changedTouches[0].clientY - DIBUJAR.xreal);
            console.log(this.posicion);
            this.dibujando = true;
          };
        ...
        DIBUJAR.canvas.ontouchmove = function (e) {
            e.preventDefault();
            if (this.dibujando) {
              let fin = DIBUJAR.ajustarPosicion(e.changedTouches[0].clientX - DIBUJAR.xreal, e.changedTouches[0].clientY - DIBUJAR.yreal);
