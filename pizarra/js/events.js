window.onload = function () {
    ...
    DIBUJAR.lapiz.onclick = function() {
        ...
        DIBUJAR.canvas.ontouchstart = function (e) {
            e.preventDefault();
            this.posicion = DIBUJAR.ajustarPosicion(e.changedTouches[0].clientX -x, e.changedTouches[0].clientY - y);
            console.log(this.posicion);
            this.dibujando = true;
          };
        ...
        DIBUJAR.canvas.ontouchmove = function (e) {
            e.preventDefault();
            if (this.dibujando) {
              let fin = DIBUJAR.ajustarPosicion(e.changedTouches[0].clientX - x, e.changedTouches[0].clientY - y);
