window.onload = function () {
    ...
    DIBUJAR.canvas.addEventListener('touch', () =>{
                DIBUJAR.canvas.addEventListener('touchstart', (e) =>{
                this.posicion = DIBUJAR.ajustarPosicion(e.clientX, e.clientY);
                console.log(this.posicion);
                this.borrar = true;
            })

            DIBUJAR.canvas.addEventListener('touchend', (e) =>{
                DIBUJAR.ajustarPosicion(e.clientX, e.clientY);
                this.dibujando = false;
                
            })

            DIBUJAR.canvas.addEventListener('touchmove', (e) =>{
                if (this.dibujando) {
                    let fin = DIBUJAR.ajustarPosicion(e.clientX, e.clientY);
