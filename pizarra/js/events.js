window.onload = function () {
    ...
    DIBUJAR.lapiz.onclick = function() {
        ...
        DIBUJAR.canvas.ontouchstart = function (e) {
            e.preventDefault();
            this.posicion = DIBUJAR.ajustarPosicion(e.changedTouches[0].clientX - clientX, e.changedTouches[0].clientY - clientY);
            console.log(this.posicion);
            this.dibujando = true;
          };
        ...
        DIBUJAR.canvas.ontouchend = function (e) {
            e.preventDefault();
            DIBUJAR.ajustarPosicion(
              e.changedTouches[0].clientX - clientX,
              e.changedTouches[0].clientY - clientY
            );
            this.dibujando = false;
          }
        ...
        DIBUJAR.canvas.ontouchmove = function (e) {
            e.preventDefault();
            if (this.dibujando) {
              let fin = DIBUJAR.ajustarPosicion(e.changedTouches[0].clientX - clientX, e.changedTouches[0].clientY - clientY);
    ...
    DIBUJAR.borrador.onclick = function() {
        ...
        DIBUJAR.canvas.ontouchstart = function (e) {
            e.preventDefault();
            this.posicion = DIBUJAR.ajustarPosicion(e.changedTouches.clientX, e.changedTouches[0].clientY);
            console.log(this.posicion);
            this.borrar = true;
          }
