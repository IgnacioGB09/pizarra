window.onload = function () {
    ...
    DIBUJAR.lapiz.onclick = function() {
        ...
        this.posicion = DIBUJAR.ajustarPosicion(e.offsetX, e.offsetY);
        console.log(this.posicion);
        this.dibujando = true;
        }

        DIBUJAR.canvas.ontouchstar = function(e) {
            e.preventDefault();
            this.posicion = DIBUJAR.ajustarPosicion(e.changedTouches[0].offsetX, e.changedTouches[0].offsetY);
            console.log(this.posicion);
            this.dibujando = true;
        ...
        DIBUJAR.canvas.onmouseup = function(e) {
            DIBUJAR.ajustarPosicion(e.offsetX, e.offsetY);
        ...
        DIBUJAR.canvas.onmousemove  = function(e) {
            if (this.dibujando) {
            let fin = DIBUJAR.ajustarPosicion(e.offsetX, e.offsetY);
        ...
        DIBUJAR.canvas.ontouchmove = function (e) {
            e.preventDefault();
            if (this.dibujando) {
              let fin = DIBUJAR.ajustarPosicion(e.changedTouches[0].offsetX, e.changedTouches[0].offsetY);
