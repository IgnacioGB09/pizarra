...
const DIBUJAR = {
    ...
    ajustarPosicion: function (x,y) {
        ...
        let xreal = x - tamCanva.x;
        let yreal = y - tamCanva.y;
        let xcelular = changedTouches[0] - xreal;
        let ycelular = changedTouches[0] - yreal;
        return {xx:xreal, yy:yreal, xx:xcelular, yy:ycelular};
    },
